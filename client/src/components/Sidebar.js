    ...
    <nav className="nav-menu">
            ...
            <div className="nav-menu-items">
                    ...
                    {props.user && props.user.usertype === "admin" && (
                      <div className="d-flex align-items-center justify-content-center"><NavLink className={({ isActive }) => (isActive ? 'active sb-link text-light ps-3' : 'sb-link text-light ps-3')} to="/manageusers" ><RiUserSettingsFill className="me-2"/>Manage Users</NavLink></div>
                    )}
